...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
  <div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="index.php">
      <span class="">
              <img style="object-fit: cover; border-radius: 500px;" height="100px" src="assets/img/logo.png">
      </span>
    </a>
    <!-- User -->
...
<div class="main-content">
  ...
  <div class="header pb-8 pt-5 pt-md-8" style="background-image: url(<?php echo $background; ?>); background-size: cover; background-position: center;">
    <div class="container-fluid">
